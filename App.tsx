...
import { fetchItalianMeals } from "./service/MealAPI";
import { loadFavoriteIds, saveFavoriteIds } from "./service/Storage";
...
const styles = StyleSheet.create({
  ...
  centered: { flex: 1, padding: 16, justifyContent: "center" },
